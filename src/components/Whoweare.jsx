  ...
  return (
    <div className=" flex justify-around p-4 w-4/5 mx-auto flex-col md:flex-row">
      <div className=" basis-1/3">
        ...
        <span className=" p-3 text-4xl font-kanit text-secondary">
          Who We Are
        </span>
      </div>
      <div className="basis-2/3 font-light text-center md:text-left font-inter">
        ...
        dicta quisquam voluptate. Lorem ipsum dolor sit amet consectetur
        adipisicing elit. At iste neque recusandae nam, quia facere, autem non
        exercitationem perferendis atque a? Quis eligendi in modi expedita
        necessitatibus ut iste aut?
      </div>
    </div>
  );
};
